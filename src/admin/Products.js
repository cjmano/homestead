            ...
            <div className="card">
              ...
              <div className="card-body" style={{backgroundColor: '#f7fafc', width: '100%'}}>
                  ...
                  <div className="modal-dialog" role="document">
                    <div className="modal-content">
                      ...
                      <div className="modal-body">
                        <p className="small">Create a new Product using this form, make sure you fill them all</p>
                        <form>
                          <div className="row">
                ...
                <div className="table-responsive">
                  ...
                  <table id="multi-filter-select" className="display table table-striped table-hover get">
                    <thead>
                      <tr>
                        <th>Produt Id</th>
                        <th>Product Name</th>
                      ...
                      <tr><td>85900</td>
                        ...
                        <td>
                          <div className="form-button-action">
                            <button type="button" data-toggle="tooltip" title className="btn btn-xs btn-sm btn-success " data-original-title="edit"><i className="fa fa-edit" /></button>&nbsp;&nbsp;
                            <button type="button" data-toggle="tooltip" title className="btn btn-xs btn-sm btn-danger " data-original-title="delete"><i className="fa  fa-trash-alt" /></button>&nbsp;&nbsp;
                          </div>
                        </td></tr>
                    </tbody>
                  </table>
